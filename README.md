...
**Exercises:**
- **Ex 01** — `pwd` — Find where you are in the terminal *(Monday, Week 1)*
- **Ex 02** — `ls` — See what is inside any folder *(Thursday, Week 1)*
- **Ex 03** — `cd` — Navigate folders with 4 powerful forms *(Monday, Week 2)*
- **Ex 04** — `mkdir` & `rmdir` — Create and remove folder structures *(Thursday, Week 2)*
